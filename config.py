...
# (monitor, painel e imagens de alerta) — ninguem e identificavel nas
# imagens renderizadas. Nao afeta a inferencia.
PRIVACY_FACE_MASK_ENABLED = True
# "pixelate" (mosaico, default), "blur" (desfoque gaussiano) ou "solid"
# (circulo cinza). Cabecas muito pequenas usam sempre "solid".
PRIVACY_FACE_MASK_STYLE = "pixelate"
